...
document.addEventListener("click", function (e) {
    ...
    if ((e.target as HTMLButtonElement).className == "notify-button") {
        ...
        request.specs.storage = ((e.target as HTMLButtonElement).dataset.storage)+" GB";
        console.log(request);
    ...
    if ((e.target as HTMLButtonElement).className == "assign-button") {
        ...
        (document.getElementById("device_id")as HTMLInputElement).value = ((e.target as HTMLButtonElement).dataset.id);
        document.getElementById("device_id").innerHTML = ((e.target as HTMLButtonElement).dataset.id);
    }
    ...
    if ((e.target as HTMLButtonElement).className == "assigndevice-btn") {
        ...
        assign.device_id = +((document.getElementById("device_id")as HTMLInputElement).value);
        assign.return_date = (document.getElementById("return_date")as HTMLInputElement).value;
        assign.first_name = (document.getElementById("first_name")as HTMLInputElement).value;
        assign.middle_name = (document.getElementById("middle_name")as HTMLInputElement).value;
        assign.last_name = (document.getElementById("last_name")as HTMLInputElement).value;
