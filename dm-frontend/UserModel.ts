   ...
   getDate(dateString: string)
    {
	 ...
	 GenerateTableRow()
	 {
		...
		return `<tr>
					...
					<td>
						<label class="switch">
							<input type="checkbox" id="${this.userId}"  data-toggle="modal"  data-target="#aiModal" ${status}>
							<span class="slider round"></span>
						</label>
					</td>
					<td><input  type="button" id="${this.userId}" class="userEditData" value="Edit" /></td>
					<td><input  type="button" id="${this.userId}"  data-toggle="modal" value="Delete" data-target="#deleteModal" /></td>
